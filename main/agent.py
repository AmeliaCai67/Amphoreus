...
def init_chrysos_heir():
    heir_profiles = {
        ...
        "KaLos618": {
            ...
            "path": "浪漫",
            "drive": "启迪",
            "profile": "黄金裔领袖，拥有‘编织金丝’能力，以监视与守护为使命。自身体力不断耗损，最终放弃生命，为同伴铺路。",
        ...
        "PoleMos600": {
            ...
            "path": "纷争",
            "drive": "重生", 
            "profile": "万敌，拥有不死赐福，王族后裔却拒绝称王，退位加入战斗，为同伴牺牲后死于背刺。",
        ...
        "Cerydra101": {
            ...
            "path": "律法",
            "drive": "审判",
            "profile": "翁法罗斯“女皇”,曾肃清元老院，并建立黄金裔的律法；有野心，渴望征服星辰大海，就像一团永不熄灭的火焰，灼热而明亮",
            "memory": ["星辰将追随陛下的伟业"]
        },
        "EleOs252": {
            "name": "风堇",
        ...
        "Hysilens":{
            ...
            "path": "海洋",
            "drive": "欢庆",
            "profile": "斯缇科西亚骑士团统领，自称“大海之女”，有高贵且神秘气质；是海妖族最后的遗孤，性格比较纯粹，从心而动",
            "memory": ["愿下一场欢宴永不谢幕"]
        },
        "SkeMma720": {
            "name":"那刻夏",
